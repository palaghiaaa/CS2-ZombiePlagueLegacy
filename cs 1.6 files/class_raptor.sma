...
=========================================== */
new const zclass1_name[] =      {   "Raptor"         };
new const zclass1_info[] =      {   "\r(Fast)"         };
new const zclass1_model[] =      {   "z_out_raptor"         };
...
const zclass1_speed =   305;
const zclass1_infecthp =   200;
...
const Float:zclass1_knockback =   1.34;
...
public plugin_init()
{
   register_plugin(    "[CS16] ZClass Raptor", "1.0", "CS16 Team"          );
   RegisterHam(          Ham_Killed, "player", "fw_PlayerKilled"            );
   g_zclass_raptor = zp_register_zombie_class(     zclass1_name, zclass1_info, zclass1_model, zclass1_clawmodel, zclass1_health, zclass1_speed, zclass1_gravity, zclass1_knockback     );
}


/* ======================================
   When RAPTOR kill other human
====================================== */
public fw_PlayerKilled(        victim, attacker, shouldgib      )
{
   if (   is_user_alive(            attacker     )   &&    zp_get_user_zombie(         attacker    )    &&         zp_get_user_zombie_class(        attacker     ) == g_zclass_raptor        )
   {
...
/* ======================================
   When RAPTOR infect other human
====================================== */
public zp_user_infected_post(   id, infector     )
{
   if (     (is_user_connected(infector) && zp_get_user_zombie_class(    infector    ) == g_zclass_raptor    ))
   {
      ...
      set_user_rendering(       infector, kRenderFxGlowShell, 210, 105, 30, kRenderNormal, 27      );

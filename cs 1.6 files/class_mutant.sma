...
=========================================== */
new const zclass1_name[] =      {   "Mutant"         };
new const zclass1_info[] =      {   "\r(More Health)"         };
new const zclass1_model[] =      {   "z_out_mutant"         };
new const zclass1_clawmodel[] =   {   "z_out_mutant_claws.mdl"   };


/* ================
   Atribs
================ */
const zclass1_health =   6250;
...
public plugin_init()
{
   register_plugin(    "[CS16] ZClass Mutant", "1.0", "CS16 Team"          );
   RegisterHam(          Ham_Killed, "player", "fw_PlayerKilled"            );
   g_zclass_mutant = zp_register_zombie_class(     zclass1_name, zclass1_info, zclass1_model, zclass1_clawmodel, zclass1_health, zclass1_speed, zclass1_gravity, zclass1_knockback     );
}


/* ======================================
   When MUTANT kill other human
====================================== */
public fw_PlayerKilled(        victim, attacker, shouldgib      )
{
   if (   is_user_alive(            attacker     )   &&    zp_get_user_zombie(         attacker    )    &&         zp_get_user_zombie_class(        attacker     ) == g_zclass_mutant        )
   {
      do_screen_fade(     attacker, 0.60, 1.15, 255, 215, 0, 94    );
...
/* ======================================
   When MUTANT infect other human
====================================== */
public zp_user_infected_post(   id, infector     )
{
   if ( is_user_connected( infector ) && zp_get_user_zombie_class(    infector    ) == g_zclass_mutant    )
   {
      do_screen_fade(     infector, 0.60, 1.15, 255, 215, 0, 94    );
      do_field_of_view(    infector, random_num(      110, 121        )          );
      set_user_rendering(       infector, kRenderFxGlowShell, 255, 215, 0, kRenderNormal, 27      );

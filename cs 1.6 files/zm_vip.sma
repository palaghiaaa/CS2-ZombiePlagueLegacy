...
public plugin_init() {
	...
	g_armor = register_cvar("zp_vip_armor", "100")
	...
	g_happy_hour = register_cvar("zp_vip_happy_hour", "19-08")
...
public client_connect(id) {
	...
	if(get_pcvar_num(g_show_vips) == 1 && get_user_flags(id) & VIPACCES) {
		...
		client_printcolor(0, "/g[ZOMBIE.THEXFORCE.RO] /yVIP /g%s /yconnected", name );
	}
#if MODE & (1<<0)
	else {
		static hours[6], hour1s[3], hour2s[3], hour1, hour2, h, m, s
...
#endif
	else client_printcolor(id, "/g[ZOMBIE.THEXFORCE.RO] /yYou are not a /gVIP" );

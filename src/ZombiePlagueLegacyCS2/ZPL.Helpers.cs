...
using static ZombiePlagueLegacyCS2.ZPLVoxCFG;

namespace ZombiePlagueLegacyCS2;

public partial class ZPLHelpers
{
    private readonly ILogger<ZPLHelpers> _logger;
    ...
    public void KnockBackZombie(IPlayer attacker, IPlayer target, string inflictor, float force, bool isheadshot, ZPLMainCFG CFG)
    {

...
/// Han 僵尸瘟疫 API.
/// </summary>
public interface IZombieOutstandingAPI
{
    /// <summary>
    ...
    /// </summary>
    void ZO_SetTargetZombie(IPlayer player);
    ...
    /// （直接转换，非通过感染或解药方式）
    /// </summary>
    void ZO_SetTargetHuman(IPlayer player);
    ...
    /// 感染逻辑与游戏寻找母体丧尸的规则一致。
    /// </summary>
    void ZO_InfectMotherZombie(IPlayer player);
    ...
    void ZO_InfectPlayer(IPlayer player, bool IgnoreScbaSuit);
    ...
    void ZO_SetTargetNemesis(IPlayer player);
    ...
    void ZO_SetTargetAssassin(IPlayer player);
    ...
    void ZO_SetTargetTVaccine(IPlayer player);
    ...
    void ZO_SetTargetSniper(IPlayer player);
    ...
    void ZO_SetTargetSurvivor(IPlayer player);
    ...
    void ZO_SetTargetHero(IPlayer player);
    ...
    void ZO_GiveTVirusGrenade(IPlayer player);
    ...
    void ZO_GiveScbaSuit(IPlayer player);
    ...
    void ZO_GiveGodState(IPlayer player, float time);
    ...
    void ZO_GiveInfiniteAmmo(IPlayer player, float time);
    ...
    void ZO_HumanAddHealth(IPlayer player, int valve);
    ...
    string ZO_GetZombieClassname(IPlayer player);
    ...
    int ZO_GetZombieMaxHealth(IPlayer player, bool original);
    ...
    /// 如果满足任一结束条件，则立即结束回合。
    /// </summary>
    void ZO_CheckRoundWinConditions();
    ...
    void ZO_SetPlayerGlow(IPlayer player, int R, int G, int B, int A);
    ...
    void ZO_RemovePlayerGlow(IPlayer player);
    ...
    void ZO_SetPlayerFov(IPlayer player, int fov);
    ...
    void ZO_GiveFireGrenade(IPlayer player);
    ...
    void ZO_GiveLightGrenade(IPlayer player);
    ...
    void ZO_GiveFreezeGrenade(IPlayer player);
    ...
    void ZO_GiveTeleportGrenade(IPlayer player);
    ...
    void ZO_GiveIncGrenade(IPlayer player);
    ...
    void ZO_SetExternalPreference(ulong steamId, string? className);
    ...
    /// </returns>
    string? ZO_GetZombieNameBySteamid(ulong steamId);
    ...
    /// </returns>
    ZombiePropertySnapshot? ZO_GetZombieProperties(string zombieName);
    ...
    /// </remarks>
    event Action<bool>? ZO_OnGameStart;
    ...
    /// </summary>
    event Action<IPlayer, IPlayer, bool, string>? ZO_OnPlayerInfect;
    ...
    /// </summary>
    event Action<IPlayer>? ZO_OnMotherZombieSelected;
    ...
    /// </summary>
    event Action<IPlayer>? ZO_OnNemesisSelected;
    ...
    /// </summary>
    event Action<IPlayer>? ZO_OnAssassinSelected;
    ...
    /// </summary>
    event Action<IPlayer>? ZO_OnHeroSelected;
    ...
    /// </summary>
    event Action<IPlayer>? ZO_OnSurvivorSelected;
    ...
    /// </summary>
    event Action<IPlayer>? ZO_OnSniperSelected;
    ...
    /// </summary>
    event Action<bool>? ZO_OnHumanWin;
    ...
    /// </summary>
    event Action<string>? ZO_OnGameModeSelect;
    ...
    /// </summary>
    event Action<ulong, string?>? ZO_OnPreferenceChanged;

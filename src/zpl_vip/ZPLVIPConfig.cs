...
/// <summary>
/// Configuration model for the ZombiePlagueLegacyCS2 VIP plugin.
/// Loaded from configs/plugins/ZPLVIP/ZPLVIP.jsonc (key "ZPLVIP").
/// Hot-reload supported: changes apply without restarting the server.
/// </summary>
public class ZPLVIPConfig
{
    // ── VIP Detection ─────────────────────────────────────────────────────────
    ...
    /// </summary>
    public string VIPPermission { get; set; } = "@zplvip/vip";
    ...
    /// Requires IZombiePlagueLegacyAPI to be present. Disabled by default.

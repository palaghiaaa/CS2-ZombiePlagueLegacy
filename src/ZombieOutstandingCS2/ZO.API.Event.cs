...
public partial class ZombieOutstandingAPI : IZombieOutstandingAPI, IDisposable
{
    ...
    */
    ...
    public event Action<bool>? ZO_OnGameStart
    {
    ...
    */
    ...
    public event Action<IPlayer, IPlayer, bool, string>? ZO_OnPlayerInfect
    {
    ...
    */
    ...
    public event Action<IPlayer>? ZO_OnMotherZombieSelected
    {
    ...
    */
    ...
    public event Action<IPlayer>? ZO_OnNemesisSelected
    {
    ...
    */
    ...
    public event Action<IPlayer>? ZO_OnAssassinSelected
    {
    ...
    */
    ...
    public event Action<IPlayer>? ZO_OnHeroSelected
    {
    ...
    */
    ...
    public event Action<IPlayer>? ZO_OnSurvivorSelected
    {
    ...
    */
    ...
    public event Action<IPlayer>? ZO_OnSniperSelected
    {
    ...
    */
    ...
    public event Action<bool>? ZO_OnHumanWin
    {
    ...
    */
    ...
    public event Action<string>? ZO_OnGameModeSelect
    {
    ...
    */
    ...
    public event Action<ulong, string?>? ZO_OnPreferenceChanged
    {

...
public class ZOWeaponsMenu
{
    private readonly ILogger<ZOWeaponsMenu> _logger;
    private readonly ISwiftlyCore _core;
    private readonly ZOGlobals _globals;
    private readonly ZOHelpers _helpers;
    private readonly ZOMenuHelper _menuHelper;
    private readonly IOptionsMonitor<ZOWeaponsCFG> _weaponsCFG;

    public ZOWeaponsMenu(
        ISwiftlyCore core,
        ILogger<ZOWeaponsMenu> logger,
        ZOGlobals globals,
        ZOHelpers helpers,
        ZOMenuHelper menuHelper,
        IOptionsMonitor<ZOWeaponsCFG> weaponsCFG)
    {
        _core = core;
        _logger = logger;
        _globals = globals;

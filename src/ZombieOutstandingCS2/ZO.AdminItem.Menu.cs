...
public class ZOAdminItemMenu
{
    private readonly ILogger<ZOAdminItemMenu> _logger;
    ...
    public ZOAdminItemMenu(ISwiftlyCore core, ILogger<ZOAdminItemMenu> logger,
        ZOMenuHelper menuHelper, IOptionsMonitor<ZOMainCFG> mainCFG,
        ZOHelpers helpers, ZOServices service, ZOGlobals globals,
        ZOGameMode gameMode)
    {
        _core = core;
        _logger = logger;

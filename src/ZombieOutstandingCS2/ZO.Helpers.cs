...
using static ZombieOutstandingCS2.ZOVoxCFG;

namespace ZombieOutstandingCS2;

public partial class ZOHelpers
{
    private readonly ILogger<ZOHelpers> _logger;
    private readonly ISwiftlyCore _core;
    private readonly ZOGlobals _globals;
    private readonly IOptionsMonitor<ZOMainCFG> _mainCFG;

    public ZOHelpers(ISwiftlyCore core, ILogger<ZOHelpers> logger,
        ZOGlobals globals, IOptionsMonitor<ZOMainCFG> mainCFG)
    {
        _core = core;
        _logger = logger;
        _globals = globals;
    ...
    public void SetAmbSounds(ZOMainCFG CFG, ZOGlobals _globals)
    {
    ...
    public void KnockBackZombie(IPlayer attacker, IPlayer target, string inflictor, float force, bool isheadshot, ZOMainCFG CFG)
    {
    ...
    public void SetAllDefaultModel(ZOMainCFG CFG)
    {

...
public class ZOGameMode
{
    private readonly ILogger<ZOGameMode> _logger;
    ...
    public ZOGameMode(ISwiftlyCore core, ILogger<ZOGameMode> logger,
        IOptionsMonitor<ZOMainCFG> mainCFG, IOptionsMonitor<ZOVoxCFG> voxCFG,
        ZOGlobals globals)
    {
        _core = core;
        _logger = logger;

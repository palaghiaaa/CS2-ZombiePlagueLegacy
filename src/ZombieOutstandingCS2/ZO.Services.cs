...
{
    private readonly ILogger<ZOServices> _logger;
    ...
    public ZOServices(ISwiftlyCore core, ILogger<ZOServices> logger,
        ZOGlobals globals, ZOHelpers helpers, 
    ...
    public void GiveSpawnGrenade(IPlayer player, ZOMainCFG CFG)
    {

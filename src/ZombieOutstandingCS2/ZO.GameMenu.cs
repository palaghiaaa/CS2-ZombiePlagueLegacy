...
public class ZOGameMenu
{
    ...
    private void TryJoinSpectator(IPlayer player)
    {
        ...
        {
            _logger.LogWarning(ex, "[ZOGameMenu] Failed to move {Name} to spectator.", player.Name);
